...
GatherMateData.generatedVersion = "554"
...
function GatherMateData:PerformMerge(dbs, style, zoneFilter)
	...
	if dbs["Archaeology"] then self:MergeArchaeology(style ~= "Merge", filter) end
...
function GatherMateData:MergeArchaeology(clear, zoneFilter)
